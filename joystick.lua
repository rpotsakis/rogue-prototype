...
function newJoystick( params )
	...
	if params.outerImage and params.outerImage ~= "" then
		...
		joystickOuter:setFillColor( 1 , 1 , 1 )
		joystick:insert( joystickOuter )
		joystick.joystickOuter = joystickOuter
	end
	...
	-- Generate Touch Object - NOTE: ghost can't 0 or touch will not register
	if not params.ghost or params.ghost == "" then params.ghost = 0.05 end
	joystickTouch = display.newCircle( joystick.joystickOuter.x , joystick.joystickOuter.y , joystick.joystickInner.width / 2 )
	joystickTouch:setFillColor( 1 , 1 , 1 , params.ghost )
	...
	if not params.position_y or params.position_y == "" then params.position_y = display.contentHeight - 15 - joystick.joystickOuter.height end
